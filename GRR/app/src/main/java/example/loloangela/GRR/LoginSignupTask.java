...
public class LoginSignupTask extends AsyncTask<String, Void, String>{
    ...
    public LoginSignupTask(LoadingActivity validator, int i, TextView errTv, Button btn, ProgressBar pb){
        context = validator;
        decider = i;
...
//                context.startActivity(new Intent(context, MapActivity.class));
                ...
                if(result.equalsIgnoreCase("-2")){
                    // Show error for different username
                    ...
                    new RatingTask((LoadingActivity) context, 3).execute(String.valueOf(me.getUser_id()));
                    // Send to Baseline
